export function Personaggio({eroe}){

    return(
        <div>
            {eroe === 'paladin' ? <h2>Hai scelto il Paladino</h2> : <h2>Hai scelto il Mago</h2>}
            {eroe === 'paladin' && <h3>Nella luce del sole brillante, un paladino emerge, 
            ...
            {eroe === 'mage' && <h3>Le mani della maga sono agili e delicate, ma vibrano 
